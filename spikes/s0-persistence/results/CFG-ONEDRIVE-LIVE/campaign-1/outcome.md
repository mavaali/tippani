...
| Ownership marker | `tippani-s0:s0-onedrive-live-c1-1788212697875` |
...
| `S0-COL-002` | absolute | Pass | 12911.446 | accounts=1; clientProcesses=2; logicalActors=Synthetic Client 1,Synthetic Client 2; winners=1; staleConflicts=1; noSilentOverwrite=true | [JSON](raw-results.json) |
| `S0-COL-003` | absolute | Pass | 15486.127 | accounts=1; clientProcesses=2; staleGeneration=0; reloadedGeneration=1; reconciledGeneration=2; deterministicReconnect=true | [JSON](raw-results.json) |
| `S0-COL-004` | absolute | Pass | 7655.268 | lostResponseDetected=true; noDuplicate=true; reconciledGeneration=1 | [JSON](raw-results.json) |
| `S0-COL-005` | absolute | Pass | 8238.288 | offlinePendingConflicted=true; noSilentOverwrite=true; authorityGeneration=2 | [JSON](raw-results.json) |
| `S0-COL-006` | absolute | Pass | 10151.253 | accounts=1; clientProcesses=2; changeMechanism=Graph drive-item polling; observedGeneration=1 | [JSON](raw-results.json) |
...
| `S0-BCK-002` | absolute | Pass | 8853.128 | winners=1; staleConflicts=1; durableGeneration=2 | [JSON](raw-results.json) |
...
| `S0-BCK-005` | absolute | Pass | 9325.996 | faultsRejected=3; generationUnchanged=true; throttleResponses=1; retries=0; transferredBytes=35137 | [JSON](raw-results.json) |
| `S0-BCK-006` | relative | Blocked | 0.882 | Blocked — requires a Windows OneDrive sync-client profile to measure synced-folder conflicts. | [JSON](raw-results.json) |
...
| `S0-MIG-004` | absolute | Pass | 3664.182 | workspaceIdPreserved=true; generation=1; receipt=true | [JSON](raw-results.json) |
...
| `S0-BKP-003` | absolute | Pass | 7325.097 | recoveredGeneration=1 | [JSON](raw-results.json) |
| `S0-BKP-004` | absolute | Pass | 13323.559 | restoredGeneration=2; oneHead=true | [JSON](raw-results.json) |
...
| `S0-REC-003` | absolute | Pass | 5481.985 | outageRejected=true; recoveredGeneration=1 | [JSON](raw-results.json) |
| `S0-REC-004` | absolute | Pass | 8573.334 | discoveredNewerAuthority=true; noSilentOverwrite=true | [JSON](raw-results.json) |
...
| `S0-SEC-001` | absolute | Pass | 1.190 | providerPreflightRejected=true; errorCount=8 | [JSON](raw-results.json) |
| `S0-SEC-002` | absolute | Pass | 1.033 | corporateFallbackImpossible=true | [JSON](raw-results.json) |
| `S0-SEC-003` | absolute | Pass | 1.498 | syntheticFixtureAccepted=true; actualDataRejected=true | [JSON](raw-results.json) |
| `S0-SEC-004` | absolute | Pass | 0.722 | configSecretRejected=true; workspaceHasNoSecrets=true | [JSON](raw-results.json) |
| `S0-SEC-005` | absolute | Pass | 0.875 | ownedAuthorized=true; foreignRefused=true | [JSON](raw-results.json) |
| `S0-SEC-006` | absolute | Pass | 1.093 | nonPositiveBudgetsRejected=true | [JSON](raw-results.json) |
...
|---|---|---:|---|
| `S0-COL-006` | collaboratorDiscoveryMs | 1360.000 | ms |
| `S0-PER-004` | setupMs_small | 6202.192 | ms |
| `S0-PER-004` | warmupMs_small | 3054.543 | ms |
| `S0-PER-004` | remoteCasMinMs_small | 1340.460 | ms |
| `S0-PER-004` | remoteCasP50Ms_small | 1388.987 | ms |
| `S0-PER-004` | remoteCasP95Ms_small | 1601.149 | ms |
| `S0-PER-004` | remoteCasMaxMs_small | 1601.149 | ms |
| `S0-PER-004` | remoteCasMeanMs_small | 1471.691 | ms |
| `S0-PER-004` | remoteCasStdDevMs_small | 114.183 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_small | 806.691 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_small | 964.628 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_small | 1144.579 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_small | 1144.579 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_small | 957.749 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_small | 106.455 | ms |
| `S0-PER-004` | cleanupMs_small | 0.093 | ms |
| `S0-PER-004` | setupMs_medium | 5289.166 | ms |
| `S0-PER-004` | warmupMs_medium | 2584.310 | ms |
| `S0-PER-004` | remoteCasMinMs_medium | 1386.122 | ms |
| `S0-PER-004` | remoteCasP50Ms_medium | 1606.907 | ms |
| `S0-PER-004` | remoteCasP95Ms_medium | 2220.939 | ms |
| `S0-PER-004` | remoteCasMaxMs_medium | 2220.939 | ms |
| `S0-PER-004` | remoteCasMeanMs_medium | 1759.950 | ms |
| `S0-PER-004` | remoteCasStdDevMs_medium | 308.229 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_medium | 886.083 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_medium | 925.195 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_medium | 1693.914 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_medium | 1693.914 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_medium | 1118.771 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_medium | 333.381 | ms |
| `S0-PER-004` | cleanupMs_medium | 0.007 | ms |
| `S0-PER-004` | setupMs_stress | 7051.260 | ms |
| `S0-PER-004` | warmupMs_stress | 3737.659 | ms |
| `S0-PER-004` | remoteCasMinMs_stress | 1512.268 | ms |
| `S0-PER-004` | remoteCasP50Ms_stress | 1512.268 | ms |
| `S0-PER-004` | remoteCasP95Ms_stress | 1539.380 | ms |
| `S0-PER-004` | remoteCasMaxMs_stress | 1539.380 | ms |
| `S0-PER-004` | remoteCasMeanMs_stress | 1525.824 | ms |
| `S0-PER-004` | remoteCasStdDevMs_stress | 13.556 | ms |
| `S0-PER-004` | collaboratorDiscoveryMinMs_stress | 917.694 | ms |
| `S0-PER-004` | collaboratorDiscoveryP50Ms_stress | 917.694 | ms |
| `S0-PER-004` | collaboratorDiscoveryP95Ms_stress | 943.805 | ms |
| `S0-PER-004` | collaboratorDiscoveryMaxMs_stress | 943.805 | ms |
| `S0-PER-004` | collaboratorDiscoveryMeanMs_stress | 930.749 | ms |
| `S0-PER-004` | collaboratorDiscoveryStdDevMs_stress | 13.056 | ms |
| `S0-PER-004` | cleanupMs_stress | 0.006 | ms |
| `S0-PER-004` | throttleFailureLatencyMs | 2161.935 | ms |
