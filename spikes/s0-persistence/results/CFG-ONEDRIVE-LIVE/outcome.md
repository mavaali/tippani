...
| Ownership marker | `tippani-s0:s0-onedrive-live-20260815233143` |
...
|---|---|---|---:|---|
| `S0-BCK-002` | absolute | Pass | 17087.674 | winners=1; staleConflicts=1; durableGeneration=2 |
| `S0-BCK-005` | absolute | Pass | 14666.528 | faultsRejected=3; generationUnchanged=true |
| `S0-COL-004` | absolute | Pass | 9527.418 | lostResponseDetected=true; noDuplicate=true; reconciledGeneration=1 |
| `S0-COL-005` | absolute | Pass | 13908.811 | offlinePendingConflicted=true; noSilentOverwrite=true; authorityGeneration=2 |
| `S0-REC-003` | absolute | Pass | 11052.527 | outageRejected=true; recoveredGeneration=1 |
| `S0-REC-004` | absolute | Pass | 14775.369 | discoveredNewerAuthority=true; noSilentOverwrite=true |
| `S0-MIG-004` | absolute | Pass | 6079.616 | workspaceIdPreserved=true; generation=1; receipt=true |
| `S0-BKP-003` | absolute | Pass | 12113.099 | recoveredGeneration=1 |
| `S0-BKP-004` | absolute | Pass | 17348.437 | restoredGeneration=2; oneHead=true |
