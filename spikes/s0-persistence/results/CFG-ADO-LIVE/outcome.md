...
| Ownership marker | `tippani-s0:s0-ado-live-20260815235002` |
...
|---|---|---|---:|---|
| `S0-BCK-003` | absolute | Pass | 4253.718 | winners=1; staleConflicts=1; durableGeneration=2 |
| `S0-BCK-005` | absolute | Pass | 1672.849 | faultsRejected=3; generationUnchanged=true |
| `S0-COL-004` | absolute | Pass | 1575.808 | lostResponseDetected=true; noDuplicate=true; reconciledGeneration=1 |
| `S0-COL-005` | absolute | Pass | 2197.422 | offlinePendingConflicted=true; noSilentOverwrite=true; authorityGeneration=2 |
| `S0-REC-003` | absolute | Pass | 1957.619 | outageRejected=true; recoveredGeneration=1 |
| `S0-REC-004` | absolute | Pass | 2143.484 | discoveredNewerAuthority=true; noSilentOverwrite=true |
| `S0-MIG-004` | absolute | Pass | 1077.313 | workspaceIdPreserved=true; generation=1; receipt=true |
| `S0-BKP-003` | absolute | Pass | 2167.790 | recoveredGeneration=1 |
| `S0-BKP-004` | absolute | Pass | 3554.534 | restoredGeneration=2; oneHead=true |
